...
public class CoToCoConnectionTerminateViewTest extends CommonViewTest {

	@Test(enabled = true)
	public void testTerminateApplicationDetailsComponent() throws InterruptedException {
		// StartPage startpage = new StartPage(driver);
		// startpage.login().clickOrderManagementLink().clickCoToCoLink().navigateToView_Terminate().clickOnTerminateButton().navigateToCoToCoViewPage();
		...
		dashboardPage.navigateToView_Completed(4);
