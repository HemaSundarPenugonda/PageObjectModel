...
public class BuildingMDFRoomToResidentialConnectionTerminateViewTest extends CommonViewTest {

	@Test(enabled = true)
	public void testTerminateApplicationDetailsComponent() throws InterruptedException {

		// StartPage startpage = new StartPage(driver);
		// startpage.login().clickOrderManagementLink().clikMdfToResiLink().navigateToView_Terminate().clickOnTerminateButton().navigateToMdfResiRelocate();
		...
		dashboardPage.navigateToView_Completed(8);
