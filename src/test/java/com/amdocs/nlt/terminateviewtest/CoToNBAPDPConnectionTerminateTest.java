...
public class CoToNBAPDPConnectionTerminateTest extends CommonViewTest {

	@Test(enabled = true)
	public void testTerminateApplicationDetailsComponent() throws InterruptedException {

		// StartPage startpage = new StartPage(driver);
		// startpage.login().clickOrderManagementLink().coToNbapDpconnectionLink().navigateToView_Terminate().clickOnTerminateButton().navigateToNonResiViewUrl();
		dashboardPage.clickOrderManagementLink().coToNbapDpconnectionLink().navigateToView_Completed(10);
		...
		dashboardPage.navigateToView_Completed(10);
