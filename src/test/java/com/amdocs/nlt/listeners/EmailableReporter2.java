...
public class EmailableReporter2 implements IReporter {
    ...
    protected void writeStylesheet() {
        ...
        writer.print(".passedodd td {background-color: #D0F3B1}");
        writer.print(".passedeven td {background-color: #D0F3B1}");
        writer.print(".skippedodd td {background-color: #DDD}");
        writer.print(".skippedeven td {background-color: #CCC}");
        writer.print(".failedodd td,.attn {background-color: #F9BEBD}");
        writer.print(".failedeven td,.stripe .attn {background-color: #F9BEBD}");
...
//        writer.print("<th>Excluded Groups</th>");
        ...
        for (SuiteResult suiteResult : suiteResults) {
            ...
            for (TestResult testResult : suiteResult.getTestResults()) {
                ...
                writeTableData(timeConversion(duration), "num");
...
//                writeTableData(testResult.getExcludedGroups());
        ...
        if (testIndex > 1) {
            ...
            writeTableHeader(timeConversion(totalDuration), "num");
            ...
            for (ClassResult classResult : classResults) {
                ...
                for (MethodResult methodResult : classResult.getMethodResults()) {
                    ...
                    buffer.append("<td><a href=\"#m").append(scenarioIndex)
                            ...
                            .append(resultsCount).append("\">").append(dateConversion(start))
                            .append("</td>").append("<td rowspan=\"")
                            .append(resultsCount).append("\">")
                            .append(timeConversion(duration)).append("</td></tr>");
                    scenarioIndex++;
    ...
    private String dateConversion(long unixTimeStamp) {
