 ...
 * @author Hemsundar
 */
public class FibreWithoutServiceOrder {
    ...
    public static class Builder {
        ...
        public FibreWithoutServiceOrder build() {
            return new FibreWithoutServiceOrder(this);
        }

    }

    private FibreWithoutServiceOrder(Builder builder) {
