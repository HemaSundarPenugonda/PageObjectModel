...
public class ActiveNodeFinder {
    private String gridHostName;
    private int gridPort;
 
    private static final Logger LOGGER = Logger.getLogger(ActiveNodeFinder.class.getCanonicalName());
     ...
     */
    public ActiveNodeFinder(String gridHostName, int gridPort) {
